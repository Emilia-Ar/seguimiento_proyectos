...
<body class="bg-gray-100 font-sans">
    <nav class="bg-blue-600 text-white p-4">
        <div class="container mx-auto flex flex-col sm:flex-row justify-between items-center">
            <a href="{{ url('/') }}" class="text-2xl font-bold flex items-center mb-4 sm:mb-0">
            ...
            <div class="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-4 items-center">
                @auth
                    <a href="{{ route('dashboard') }}" class="flex items-center hover:text-gray-200">
                        <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        Panel
                    </a>
                    <a href="{{ route('proyectos.index') }}" class="flex items-center hover:text-gray-200">
                    ...
                    <a href="{{ route('tareas.index') }}" class="flex items-center hover:text-gray-200">
                        <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"></path></svg>
                        Tareas
                    </a>
                    <a href="{{ route('entregas.index') }}" class="flex items-center hover:text-gray-200">
                    ...
                    <a href="{{ route('perfil') }}" class="flex items-center hover:text-gray-200">
                ...
                @else
                    ...
                    <a href="{{ route('register') }}" class="flex items-center hover:text-gray-200">
